...
const stats = [
  { value: `${siteConfig.yearsOfExperience}+`, label: 'Years of Excellence', color: 'from-blue-600 to-cyan-500' },
  { value: siteConfig.stats.studentsTrained, label: 'Students Trained', color: 'from-cyan-500 to-teal-400' },
  { value: `${courses.length}+`, label: 'Courses Offered', color: 'from-blue-500 to-indigo-500' },
  { value: siteConfig.stats.placementRate, label: 'Placement Rate', color: 'from-indigo-500 to-blue-600' },
];
            ...
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  ...
                  has been at the forefront of technical training for over <strong className="text-foreground">{siteConfig.yearsOfExperience} years</strong>.
