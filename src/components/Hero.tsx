...
const stats = [
  { value: `${courses.length}+`, label: 'Expert Courses', icon: GraduationCap, color: 'from-blue-600 to-cyan-500' },
  { value: siteConfig.stats.studentsTrained, label: 'Happy Students', icon: Users, color: 'from-cyan-500 to-teal-400' },
  { value: `${siteConfig.yearsOfExperience}+`, label: 'Years Experience', icon: Clock, color: 'from-blue-500 to-indigo-500' },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800 text-blue-600 dark:text-blue-400 px-4 py-2 rounded-full text-sm font-medium mb-8">
            ...
            Trusted by {siteConfig.stats.studentsTrained} Students across Vadodara
          </div>
